...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/pushkarsingh/Documents/01 University/03 Self Prioritisation Research/experiment/preliminary_experiment_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        # keep track of which components have finished
        trialComponents = [fixation, label, key_resp_2, polygon]
    ...
    for thisTrial_4 in trials_4:
        ...
        _key_resp_5_allKeys = []
        # keep track of which components have finished
        block_2Components = [block2_fixation, block2_polygon, distractor_block2, blocktwo_label, key_resp_5, text_3]
