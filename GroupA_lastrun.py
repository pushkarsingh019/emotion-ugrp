...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/pushkarsingh/Documents/01 University/emotion-ugrp/GroupA_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    text_norm_4 = visual.TextStim(win=win, name='text_norm_4',
        text='The task is about to start, If the shape label pairing is correct press the key which is labeled "correct" and if its incorrect press key labeled "Incorrect" on your keyboard.\n\nShape and the label are presented for very short period of time. Ignore the emotional/nonemotional images and try to respond as fast as possible. \n\npress \'spacebar\' to continue...\n',
        font='Arial',
        units='norm', pos=(0, 0), height=0.1, wrapWidth=1.8, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    for thisTrial_3 in trials_3:
        ...
        # keep track of which components have finished
        block_1Components = [block1_fixation, distractor_block1, blockone_label, key_resp_4, block1_shape, mouse]
