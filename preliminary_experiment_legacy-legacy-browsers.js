...
function self_other_instructionRoutineBegin(snapshot) {
  return async function () {
    ...
    self_other_instructionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function self_other_infoRoutineBegin(snapshot) {
  return async function () {
    ...
    self_other_infoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function self_other_startingRoutineBegin(snapshot) {
  return async function () {
    ...
    self_other_startingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function free_view_instructionRoutineBegin(snapshot) {
  return async function () {
    ...
    free_view_instructionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function free_viewingRoutineBegin(snapshot) {
  return async function () {
    ...
    free_viewingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function block_1RoutineBegin(snapshot) {
  return async function () {
    ...
    block_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function block1_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    block1_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function block_2_newRoutineBegin(snapshot) {
  return async function () {
    ...
    block_2_newComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function block2_feedback_newRoutineBegin(snapshot) {
  return async function () {
    ...
    block2_feedback_newComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
